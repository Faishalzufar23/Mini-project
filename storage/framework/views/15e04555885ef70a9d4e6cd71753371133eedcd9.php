        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav flex-row flex-wrap">
                    ...
                    <li class="nav-item col-6 col-md-auto"><a href="<?php echo e(route('barangs.index')); ?>" class="nav-link">barang List</a></li>
                </ul>
...
<?php /**PATH C:\Users\User\Downloads\mini-project\masterBarangUts\resources\views/profile.blade.php ENDPATH**/ ?>